...
<div class="wrapper">
    <div class="header">
        <a href="/">
            <img class="headerImageFull" src="images/iceSkateAppHeader.jpg" alt="Header Image">
            <img class="headerImageMobile" src="images/iceSkateAppHeaderMobile.png" alt="Header Image">
        </a>
    </div>
